...
#source("C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/lib/train_trees.R") 
#source("C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/lib/test_trees.R")
#source("C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/lib/cross_validation_trees.R")
...
if(run.cv.trees_high){
  ...
  #save(res_cv_trees_high, file = "C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/output/res_cv_trees_high.RData")
  }
} else{
  load("../output/res_cv_trees_high.RData")
  #load("C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/output/res_cv_trees_high.RData")
}
```
...
if(run.cv.trees_low){
  ...
  #save(res_cv_trees_high, file = "C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/output/res_cv_trees_low.RData")
  }
}else{
  load("../output/res_cv_trees_low.RData")
  #load("C:/Users/sluo1/Desktop/5243/other/Spring2021-Project4-project4group8/output/res_cv_trees_low.RData")
}
```
...
Weighting, full matching and subclassification methods instead use all individuals
These methods can be thought of as giving all individuals (either implicit or explicit) weights between 0 and 1

1. Subclassification forms groups of individuals who are similar
    - current convention is to use 5–10 subclasses, however larger sample sizes can have more subclasses(10-20)
2. Full matching is a more sophisticated form of subclassification
    - Full matching creates a series of matched sets.
    - where each matched set contains at least one treated individual and at least one control individual
3. Weigthing
  
### Propensity Matching using Propensity Score from Regression Trees
```{r}
...
```{r}
weight_high <- cbind(as.numeric(A_high), prop_score_high) %>%
  as_tibble %>%
